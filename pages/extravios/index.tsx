                        ...
                        <div className="overflow-x-auto">
                            <table className="table-auto w-full">
                                ...
                                <tbody className="text-sm divide-y divide-gray-100">
                                    {extravios && extravios.map((extravio: Extravio) => {
                                        return (<tr key={extravio._id}>
                                            <td className="p-2 whitespace-nowrap">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="font-medium text-gray-800">{extravio.name_article}</div>
                                                </div>
                                            </td>
                                            <td className="p-2 whitespace-nowrap">
                                            ...
                                            <td className="p-2 whitespace-nowrap">
                                                <div className="text-left font-medium text-green-500">{convertDate(extravio.date_lost_article)}</div>
                                            </td>
                                        </tr>)
                                    })}
                                </tbody>
